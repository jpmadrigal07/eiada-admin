function approveWithdrawRequest() {
    ...
    setTimeout(function(){
        ...
        var withdrawRequestID = $("#approve-withdraw-request-id").val();
        var status = $("#approve-withdraw-request-status").val();
        ...
        if (withdrawRequestID != "") {
            ...
            $.ajax({
                type: "PUT",
                url: "/profile/withdrawal-requests/approve/" + withdrawRequestID,
                data: formData,
